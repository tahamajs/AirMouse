...
interface ISettingsRepository {
    ...
    suspend fun setAiSmoothing(enabled: Boolean)
    suspend fun setPredictiveMovement(enabled: Boolean)
    ...
    suspend fun importSettings(data: String): Boolean
    fun getSettingsVersion(): Flow<Int>
}