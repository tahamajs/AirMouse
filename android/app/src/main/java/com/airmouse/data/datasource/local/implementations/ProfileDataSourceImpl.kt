...
class ProfileDataSourceImpl @Inject constructor(
    ...
    override suspend fun deleteProfile(id: String) {
        ...
        // If the deleted profile was the default, clear the default flag
    ...
    override suspend fun toggleFavorite(id: String) {
        val favorites = prefs.getString(favoriteProfilesKey, "")
            .split(",")
    ...
    override suspend fun getFavoriteProfiles(): List<UserProfile> {
        val favoriteIds = prefs.getString(favoriteProfilesKey, "")
            .split(",")
            .filter { it.isNotEmpty() }
