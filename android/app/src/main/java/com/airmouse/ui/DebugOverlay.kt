...
class DebugOverlay(private val context: Context) {
    ...
    private fun createOverlayView() {
        ...
        overlayView = LayoutInflater.from(context).inflate(com.airmouse.R.layout.debug_overlay, null)

        gyroTextView = overlayView!!.findViewById(com.airmouse.R.id.debug_gyro)
        accelTextView = overlayView!!.findViewById(com.airmouse.R.id.debug_accel)
        orientationTextView = overlayView!!.findViewById(com.airmouse.R.id.debug_orientation)
        gestureTextView = overlayView!!.findViewById(com.airmouse.R.id.debug_gesture)
        connectionTextView = overlayView!!.findViewById(com.airmouse.R.id.debug_connection)
        fpsTextView = overlayView!!.findViewById(com.airmouse.R.id.debug_fps)
        graphCanvas = overlayView!!.findViewById(com.airmouse.R.id.debug_graph)
