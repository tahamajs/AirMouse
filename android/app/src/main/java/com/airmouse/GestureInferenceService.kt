...
class GestureInferenceService : Service(), SensorEventListener {
    ...
    private fun loadModel() {
        try {
            ...
            Log.i("GestureInference", "Model loaded, labels: $gestureLabels")
        } catch (e: Exception) {
            Log.e("GestureInference", "Model load failed", e)
        }
    }
    ...
    private fun runPrediction() {
        ...
        try {
            ...
            Log.e("GestureInference", "Prediction error", e)
        } finally {
    ...
    private fun createNotification(): Notification {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            return Notification.Builder(this, CHANNEL_ID)
                ...
                .setContentText("Recognizing gestures...")
    ...
    private fun createNotificationChannel() {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            val channel = NotificationChannel(CHANNEL_ID, "Gesture Inference", NotificationManager.IMPORTANCE_LOW)
