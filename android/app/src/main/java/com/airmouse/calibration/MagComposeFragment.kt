...
class MagComposeFragment : Fragment(), CalibrationStepFragment {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        viewModel = ViewModelProvider(this, ViewModelProvider.AndroidViewModelFactory(requireActivity().application)).get(MagCalibrationViewModel::class.java)
        ...
        composeView.setContent {
            ...
            Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
                ...
                Box(modifier = Modifier.fillMaxWidth().height(220.dp), contentAlignment = Alignment.Center) {
                    Card(modifier = Modifier.size(160.dp), backgroundColor = Color(0xFF171B22)) {
