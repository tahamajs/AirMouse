...
func ShowShortcutsDialog(parent fyne.Window) {
	...
	// Wrap in a scroll container with a title
...
// GetShortcutText returns a formatted shortcut string (e.g., for menu items).
// Example: GetShortcutText("⌘/Ctrl", "S") returns "⌘/Ctrl + S".
