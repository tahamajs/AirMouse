...
// Execute performs a system action
...
// ExecuteGesture executes an action based on gesture name
...
// GetAvailableActions returns all available system actions
...
// GetActionDescription returns human-readable description
